...
void goToInstructions() {
    ...
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[0], 5280 / 2);
    DMANow(3, instructionsMap, &((screenblock *)0x6000000)[7], 2048 / 2);
    state = INSTRUCTIONS;
}
...
void goToLevelTwo() {
    (*(volatile unsigned short *)0x4000000) = 0 | (1<<8) | (1<<12);
    (*(volatile unsigned short*)0x4000008) = ((0)<<2) | ((7)<<8) | (0<<7) | (1<<14) | 1;

    DMANow(3, room2Pal, ((unsigned short *)0x5000000), 256);
    DMANow(3, room2Tiles, &((charblock *)0x6000000)[0], 320 / 2);
    DMANow(3, room2Map, &((screenblock *)0x6000000)[7], 4096 / 2);
